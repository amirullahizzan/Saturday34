...
namespace Tutorial
{
	...
	//! 2. BP_COMPONENT_DECL( Component○○○○, u8"ここに処理機能を書いておく" );
	...
	//! 5. あとは、オブジェクト内で、AddComponent<Component○○○○>()
	...
	public:
		BP_COMPONENT_DECL(
			ComponentSamplePlayerController,
	...
	bool Tutorial_09::Init()
	{
		...
		auto obj =
			Scene::CreateObjectPtr<Object>()->SetName( u8"テストObject" );
	...
	void Tutorial_09::GUI()
	{
		...
		ImGui::TextColored(
			{ 1, 1, 0, 1 },
			u8"[ComponentSamplePlayerController]"
		);
		ImGui::TextColored(
			{ 0, 1, 0, 1 },
...
CEREAL_REGISTER_POLYMORPHIC_RELATION(
	Tutorial::ComponentSamplePlayerController,
	Component
)
