...
#define BP_CLASS_DECL( CLASS, ... )                                                                         \
	...
	using Class =                                                                                           \
		CLASS; /*! 自クラスの型 : これ以降は親クラスではなく自クラスを指す */     \
                                                                                                            \
	/*! 型情報 */                                                                                        \
	static inline ClassTypeInfo<CLASS> Type =                                                               \
		ClassTypeInfo<CLASS>( #CLASS, &Super::Type, __VA_ARGS__ );                                          \
                                                                                                            \
	/*! 型情報を取得 */                                                                               \
...
#define BP_BASE_TYPE( CLASS )                                                                \
	using MyClass = CLASS; /*! 自クラスの型 */                                         \
                                                                                             \
	/*! 型情報 */                                                                         \
	[[deprecated( "BP_BASE_TYPE() と BP_CLASS_TYPE() "                                      \
				  "は廃止されました。BP_CLASS_DECL(クラス名, u8\"解説文\") " \
				  "に置換してください。" )]] static ClassTypeInfo<CLASS>                     \
		Type;                                                                                \
                                                                                             \
	/*! 型情報を取得 */                                                                \
...
#define BP_CLASS_IMPL( CLASS, DESC_NAME )                                                                   \
	...
	{                                                                                                       \
		[[deprecated(                                                                                       \
			"BP_CLASS_IMPL() "                                                                              \
			"は廃止されました。cppに定義する必要がなくなりましたので削除して" \
			"ください。\n    代わりにヘッダーのBP_CLASS_TYPE(クラス名, "                  \
			"親クラス名)を BP_CLASS_DECL(クラス名, u8\"解説文\") "                             \
			"に置換してください。親クラス指定も不要になりました。"                \
		)]] void                                                                                            \
...
#define BP_BASE_IMPL( CLASS, DESC_NAME )                                                                    \
	...
	{                                                                                                       \
		[[deprecated(                                                                                       \
			"BP_BASE_IMPL() "                                                                               \
			"は廃止されました。cppに定義する必要がなくなりましたので削除して" \
			"ください。\n    代わりにヘッダーのBP_BASE_TYPE(クラス名)を "                \
			"BP_CLASS_DECL(クラス名, u8\"解説文\") "                                                 \
			"に置換してください。親クラス指定も不要になりました。"                \
		)]] void                                                                                            \
		BP_BASE_IMPL_deprecated()                                                                           \
		{                                                                                                   \
...
[[nodiscard]] void* CreateInstanceFromName(
