...
//! Componentルートの型情報
ComponentTypeInfo ComponentTypeInfo::component_root =
	ComponentTypeInfo( "component_root", 0, nullptr );

ComponentTypeInfo::ComponentTypeInfo(
	const char*		   class_name,
	size_t			   class_size,
	ComponentTypeInfo* parent_type,
...
void Component::SetPriority( ProcTiming timing, ProcPriority priority )
{
	Scene::GetCurrentScene()
		->SetPriority( shared_from_this(), timing, priority );
}
