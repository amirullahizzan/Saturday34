...
#pragma warning( default: 26813 )
	...
	//! @return 押し戻しできる状態か?
	bool CalcPush(
		ComponentCollisionPtr collision,
		float3				  vec,
		float3*				  push,
		float3*				  other_push
	) const
	...
	void [[deprecated(
		"Overlap()は古い命名です。SetOverlapCollisionGroup()を使用してください"
	)]] Overlap( u32 bit )
	{
...
protected:
	...
	//! @return 当たり情報
	ComponentCollision::HitInfo isHit(
		ComponentCollisionCapsulePtr col1,
	...
	//! @return 当たり情報
	ComponentCollision::HitInfo isHit(
		ComponentCollisionSpherePtr	 col1,
	...
	isHit( ComponentCollisionSpherePtr col1, ComponentCollisionSpherePtr col2 );
	...
	//! @return 当たり情報
	ComponentCollision::HitInfo
	isHit( ComponentCollisionModelPtr col1, ComponentCollisionSpherePtr col2 );
	...
	//! @return 当たり情報
	ComponentCollision::HitInfo
	isHit( ComponentCollisionSpherePtr col1, ComponentCollisionModelPtr col2 );
	...
	//! @return 当たり情報
	ComponentCollision::HitInfo
	isHit( ComponentCollisionModelPtr col1, ComponentCollisionLinePtr col2 );
	...
	//! @return 当たり情報
	ComponentCollision::HitInfo
	isHit( ComponentCollisionModelPtr col1, ComponentCollisionCapsulePtr col2 );
	...
	//! @return 当たり情報
	ComponentCollision::HitInfo
	isHit( ComponentCollisionCapsulePtr col1, ComponentCollisionModelPtr col2 );
	...
	//! @return 当たり情報
	ComponentCollision::HitInfo
	isHit( ComponentCollisionLinePtr col1, ComponentCollisionSpherePtr col2 );
	...
	//! @return 当たり情報
	ComponentCollision::HitInfo
	isHit( ComponentCollisionLinePtr col1, ComponentCollisionCapsulePtr col2 );
	...
	//! @return 当たり情報
	ComponentCollision::HitInfo
	isHit( ComponentCollisionLinePtr col1, ComponentCollisionModelPtr col2 );
