...
ComponentObjectController::SetMoveSpeed( const float speed )
{
	move_speed_ = speed;
	return std::dynamic_pointer_cast<ComponentObjectController>(
		shared_from_this()
	);
}

ComponentObjectControllerPtr
ComponentObjectController::SetRotateSpeed( const float speed )
{
	rot_speed_ = speed;
	return std::dynamic_pointer_cast<ComponentObjectController>(
		shared_from_this()
...
ComponentObjectControllerPtr
ComponentObjectController::SetKeys( int up, int down, int left, int right )
{
	// 移動キーの設定
	key_up_	   = up;
	key_down_  = down;
...
ComponentObjectControllerPtr ComponentObjectController::SetCameraKeys(
	int up,
	int down,
	int left,
	int right
...
ComponentObjectControllerPtr
ComponentObjectController::SetTarget( ObjectPtr target )
{
	target_ = target;
	return std::dynamic_pointer_cast<ComponentObjectController>(
		shared_from_this()
